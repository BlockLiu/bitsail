...
<p>运行此脚本在编译时将Flink嵌入到BitSail的包中。<code v-pre>bash build.sh</code>。如果Flink已经在你们的集群中提供，则可以打包时只包含BitSail相关代码 <code v-pre>mvn clean package -pl bitsail-dist -am -Dmaven.test.skip=true</code></p>
