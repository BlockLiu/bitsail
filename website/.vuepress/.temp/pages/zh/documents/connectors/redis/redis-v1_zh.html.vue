...
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">写入列数据字段，类型均为string</td>
</tr>
</tbody>
</table>
...
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">连接池最大可分配实例</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_max_idle</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">连接池最大空闲实例</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_min_idle</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">连接池最小空闲实例</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_max_wait_time_ms</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">连接池最大等待时间</td>
</tr>
<tr>
<td style="text-align:left">max_attempt_count</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">重试器最大重试次数</td>
</tr>
</tbody>
</table>
<h2 id="相关文档" tabindex="-1"><a class="header-anchor" href="#相关文档" aria-hidden="true">#</a> 相关文档</h2>
<p>配置示例文档: <RouterLink to="/zh/documents/connectors/redis/redis-v1-example_zh.html">redis-connector-example</RouterLink></p>
</div></template>
