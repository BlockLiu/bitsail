...
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token property">"writer"</span><span class="token operator">:</span> <span class="token punctuation">{</span>
...
<td style="text-align:left">Yes</td>
<td style="text-align:left"></td>
<td style="text-align:left">Describing fields' names, types all set String</td>
</tr>
</tbody>
</table>
...
<tr>
<td style="text-align:left">connection_pool_max_total</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Jedis pool max total connection</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_max_idle</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">jedis pool max idle connection</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_min_idle</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Jedis pool min idle connection</td>
</tr>
<tr>
<td style="text-align:left">connection_pool_max_wait_time_ms</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Jedis pool max wait time in millis</td>
</tr>
<tr>
<td style="text-align:left">max_attempt_count</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Retryer retry count</td>
</tr>
</tbody>
</table>
<h2 id="related-document" tabindex="-1"><a class="header-anchor" href="#related-document" aria-hidden="true">#</a> Related document</h2>
<p>Configuration examples: <RouterLink to="/zh/documents/connectors/redis/redis-v1-example.html">redis-connector-example</RouterLink></p>
</div></template>
