<template><div><h1 id="doris-connector-examples" tabindex="-1"><a class="header-anchor" href="#doris-connector-examples" aria-hidden="true">#</a> Doris connector examples</h1>
<p>Parent documents: <RouterLink to="/zh/documents/connectors/doris/doris.html">doris-connector</RouterLink></p>
<h2 id="测试用doris配置" tabindex="-1"><a class="header-anchor" href="#测试用doris配置" aria-hidden="true">#</a> 测试用Doris配置</h2>
<p>Assuming the doris</p>
<ul>
