<template><div><h1 id="doris连接器" tabindex="-1"><a class="header-anchor" href="#doris连接器" aria-hidden="true">#</a> Doris连接器</h1>
<p>上级文档: <RouterLink to="/zh/documents/connectors/introduction_zh.html">connectors</RouterLink></p>
<p><em><strong>BitSail</strong></em> Doris连接器支持批式和流式写doris，其支持的主要功能点如下</p>
<ul>
<li>使用StreamLoad方式写Doris表</li>
<li>支持分区创建再写入</li>
<li>支持多种table mode</li>
</ul>
...
&lt;/dependency>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="doris写入" tabindex="-1"><a class="header-anchor" href="#doris写入" aria-hidden="true">#</a> Doris写入</h2>
<h3 id="支持的数据类型" tabindex="-1"><a class="header-anchor" href="#支持的数据类型" aria-hidden="true">#</a> 支持的数据类型</h3>
<p>写连接器使用json或者csv格式传输数据，支持常见的doris数据类型:</p>
<ul>
<li>CHAR</li>
<li>VARCHAR</li>
<li>TEXT</li>
...
<td style="text-align:left">Doris写连接器类型, <code v-pre>com.bytedance.bitsail.connector.doris.sink.DorisSink</code></td>
</tr>
<tr>
<td style="text-align:left">fe_hosts</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">Doris FE地址, 多个地址用逗号分隔</td>
</tr>
<tr>
<td style="text-align:left">mysql_hosts</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">JDBC连接Doris的地址, 多个地址用逗号分隔</td>
</tr>
<tr>
<td style="text-align:left">user</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">Doris账户</td>
</tr>
<tr>
<td style="text-align:left">password</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">Doris密码，可为空</td>
</tr>
<tr>
<td style="text-align:left">db_name</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">要写入的doris库</td>
</tr>
<tr>
<td style="text-align:left">table_name</td>
<td style="text-align:left">是</td>
<td style="text-align:left"></td>
<td style="text-align:left">要写入的doris表</td>
</tr>
<tr>
<td style="text-align:left">partitions</td>
<td style="text-align:left">分区表必需</td>
<td style="text-align:left"></td>
<td style="text-align:left">要写入的分区</td>
</tr>
<tr>
<td style="text-align:left">table_has_partition</td>
<td style="text-align:left">非分区表必需</td>
<td style="text-align:left"></td>
<td style="text-align:left">非分区表填写true</td>
</tr>
<tr>
<td style="text-align:left">table_model</td>
<td style="text-align:left">是</td>
<td style="text-align:left">UNIQUE</td>
<td style="text-align:left">要写入表的模型,目前仅支持unique表写入</td>
</tr>
</tbody>
</table>
<!--AGGREGATE<br/>DUPLICATE-->
<p>注意，partitions格式要求如下:</p>
<ol>
<li>可写入多个partition，每个partition</li>
<li>每个partition内需要有:
<ol>
<li><code v-pre>name</code>: 要写入的分区名</li>
<li><code v-pre>start_range</code>, <code v-pre>end_range</code>: 该分区范围</li>
</ol>
</li>
</ol>
<p>partitions示例:</p>
<div class="language-json line-numbers-mode" data-ext="json"><pre v-pre class="language-json"><code><span class="token punctuation">{</span>
  ...
  <span class="token punctuation">]</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="可选参数" tabindex="-1"><a class="header-anchor" href="#可选参数" aria-hidden="true">#</a> 可选参数</h4>
<table>
<thead>
<tr>
<th style="text-align:left">参数名称</th>
...
<td style="text-align:left"></td>
<td style="text-align:left">指定Doris写并发</td>
</tr>
<tr>
<td style="text-align:left">sink_flush_interval_ms</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">Upsert模式下的flush间隔, 默认5000 ms</td>
</tr>
<tr>
<td style="text-align:left">sink_max_retries</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">写入的最大重试次数，默认3</td>
</tr>
<tr>
<td style="text-align:left">sink_buffer_size</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">写入buffer最大值，默认 20971520 bytes (20MB)</td>
</tr>
<tr>
<td style="text-align:left">sink_buffer_count</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">写入buffer的最大条数，默认100000</td>
</tr>
<tr>
<td style="text-align:left">sink_enable_delete</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">是否支持delete事件同步</td>
</tr>
<tr>
<td style="text-align:left">sink_write_mode</td>
<td style="text-align:left">否</td>
<td style="text-align:left">目前只支持以下几种:<br/>STREAMING_UPSERT<br/>BATCH_UPSERT<br/>BATCH_REPLACE</td>
<td style="text-align:left">写入模式</td>
</tr>
<tr>
<td style="text-align:left">stream_load_properties</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">追加在streamload url后的参数，map&lt;string,string&gt;格式</td>
</tr>
<tr>
<td style="text-align:left">load_contend_type</td>
<td style="text-align:left">否</td>
<td style="text-align:left">csv<br/>json</td>
<td style="text-align:left">streamload使用的格式，默认json</td>
</tr>
<tr>
<td style="text-align:left">csv_field_delimiter</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">csv格式的行内分隔符, 默认逗号 &quot;,&quot;</td>
</tr>
<tr>
<td style="text-align:left">csv_line_delimiter</td>
<td style="text-align:left">否</td>
<td style="text-align:left"></td>
<td style="text-align:left">csv格式的行间分隔符, 默认 &quot;\n&quot;</td>
</tr>
</tbody>
</table>
<p>sink_write_mode的说明如下:</p>
<ul>
<li>STREAMING_UPSERT: 流式upsert写入</li>
<li>BATCH_UPSERT: 批式upsert写入</li>
<li>BATCH_REPLACE: 批式replace写入</li>
</ul>
<h2 id="相关文档" tabindex="-1"><a class="header-anchor" href="#相关文档" aria-hidden="true">#</a> 相关文档</h2>
<p>配置示例文档: <RouterLink to="/zh/documents/connectors/doris/doris-example_zh.html">doris-connector-example</RouterLink></p>
</div></template>
