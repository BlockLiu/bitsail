<template><div><h1 id="rocketmq-connector" tabindex="-1"><a class="header-anchor" href="#rocketmq-connector" aria-hidden="true">#</a> RocketMQ connector</h1>
<p>Parent document: <RouterLink to="/zh/documents/connectors/introduction.html">connectors</RouterLink></p>
<p><em><strong>BitSail</strong></em> RocketMQ connector supports writing in batch mode.</p>
...
&lt;/dependency>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="rocketmq-writer" tabindex="-1"><a class="header-anchor" href="#rocketmq-writer" aria-hidden="true">#</a> RocketMQ writer</h2>
...
<td style="text-align:left">Class name of RocketMQ writer, <code v-pre>com.bytedance.bitsail.connector.legacy.rocketmq.sink.RocketMQOutputFormat</code></td>
</tr>
<tr>
<td style="text-align:left">name_server_address</td>
<td style="text-align:left">Yes</td>
<td style="text-align:left"></td>
<td style="text-align:left">Name server address of rocketmq</td>
</tr>
<tr>
<td style="text-align:left">topic</td>
<td style="text-align:left">Yes</td>
<td style="text-align:left"></td>
<td style="text-align:left">Topic to write</td>
</tr>
<tr>
...
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Producer group for the task. If not defined, it will use a random string</td>
</tr>
<tr>
<td style="text-align:left">tag</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Tags of the produced messages</td>
</tr>
<tr>
<td style="text-align:left">enable_batch_flush</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">true: send a batch of messages at once;<br/>false: send single message at once.<br/> Default true.</td>
</tr>
<tr>
<td style="text-align:left">batch_size</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">The number of messages to send in a batch. Default 100</td>
</tr>
<tr>
<td style="text-align:left">log_failures_only</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">When send failure happens, it will:<br/>true: only log this failure,<br/>false: throw exception.<br/>Default false.</td>
</tr>
<tr>
<td style="text-align:left">enable_sync_send</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">If use sync send. Default false.</td>
</tr>
<tr>
<td style="text-align:left">access_key</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Access key for authorization.</td>
</tr>
<tr>
<td style="text-align:left">secret_key</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Secret key for authorization.</td>
</tr>
<tr>
<td style="text-align:left">send_failure_retry_times</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Max retry times for a send failure, default 3</td>
</tr>
<tr>
<td style="text-align:left">send_message_timeout_ms</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Timeout for sending a message, default 3000 ms</td>
</tr>
<tr>
<td style="text-align:left">max_message_size_bytes</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Max message size, default 4194304 bytes</td>
</tr>
<tr>
<td style="text-align:left">key</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Specify which field(s) is used as the message key.</td>
</tr>
<tr>
<td style="text-align:left">partition_fields</td>
<td style="text-align:left">No</td>
<td style="text-align:left"></td>
<td style="text-align:left">Specify which field(s) is used to select queue.</td>
</tr>
</tbody>
</table>
<h2 id="related-document" tabindex="-1"><a class="header-anchor" href="#related-document" aria-hidden="true">#</a> Related document</h2>
<p>Configuration examples: <RouterLink to="/zh/documents/connectors/rocketmq/rocketmq-example.html">rocketmq-connector-example</RouterLink></p>
</div></template>
