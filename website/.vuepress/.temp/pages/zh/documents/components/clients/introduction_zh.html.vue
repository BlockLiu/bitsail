...
<p>在应用开发过程中，应用往往需要和各种各样的组件进行连接交互，例如Kafka、rds数据库等。
本模块用于提供连接多种大数据组件的客户端。
开发者可通过引入相应依赖后方便地创建客户端。</p>
<p>目前本模块提供如下客户端的创建：</p>
<table>
<thead>
<tr>
...
<td>创建KafkaProducer</td>
<td><a href="#jump_kafka">link</a></td>
</tr>
</tbody>
</table>
<hr>
<h2 id="子模块-bitsail-components-client-kafka" tabindex="-1"><a class="header-anchor" href="#子模块-bitsail-components-client-kafka" aria-hidden="true">#</a> <span id="jump_kafka">子模块: bitsail-components-client-kafka</span></h2>
<h3 id="依赖" tabindex="-1"><a class="header-anchor" href="#依赖" aria-hidden="true">#</a> 依赖</h3>
<div class="language-j line-numbers-mode" data-ext="j"><pre v-pre class="language-j"><code><span class="token verb keyword">&lt;</span>dependency<span class="token verb keyword">></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="功能介绍" tabindex="-1"><a class="header-anchor" href="#功能介绍" aria-hidden="true">#</a> 功能介绍</h3>
<p>本模块基于<code v-pre>org.apache.kafka.clients.producer.KafkaProducer</code>提供了一个封装过的<code v-pre>KafkaProducer</code>，支持连接到指定的kafka集群，并以同步或者异步的方式发送数据到指定topic。</p>
<h4 id="构造函数" tabindex="-1"><a class="header-anchor" href="#构造函数" aria-hidden="true">#</a> 构造函数</h4>
<p>构造函数接受以下参数：</p>
<ol>
<li><code v-pre>bootstrap.servers</code>: 连接kafka集群的地址</li>
<li><code v-pre>topic</code>: 要写入的topic</li>
<li><code v-pre>userConfigs</code>（可选）: 用户自定义的producer构建属性</li>
</ol>
<p>此构造函数支持以下默认属性 (具体属性定义可查看org.apache.kafka.clients.producer.ProducerConfig):</p>
<ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="同步-异步发送" tabindex="-1"><a class="header-anchor" href="#同步-异步发送" aria-hidden="true">#</a> 同步/异步发送</h4>
<p>开发者可使用同步发送，或者传入回调方法使用异步发送。方法分别如下：</p>
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code>// 同步发送
...
<p>如下是一份完整的、可运行的使用此KafkaProducer的示例代码，发送300条指定数据到topic中。
你可以在替换相关kafka集群参数后在本地测试运行。</p>
