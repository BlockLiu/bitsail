...
<hr>
<p>Parent document: <RouterLink to="/zh/documents/components/conversion/introduction.html">bitsail-conversion-flink</RouterLink></p>
<p>The <code v-pre>HiveWritableExtractor</code> in this module supports converting <code v-pre>Row</code> into hive <code v-pre>Writable</code> data.
After the converting, users can easily use <code v-pre>org.apache.hadoop.hive.ql.exec.RecordWriter</code> to write the converted data
into hive.</p>
<p>The following sections will introduce <code v-pre>GeneralWritableExtractor</code>, an implementation of <code v-pre>HiveWritableExtractor</code>, which
can be used for hive tables of various storage formats, such as parquet, orc, text, <i>etc.</i>.</p>
...
<p><code v-pre>GeneralWritableExtractor</code> support common hive basic data types, as well as List, Map, Struct complex data types.</p>
...
<div class="language-text line-numbers-mode" data-ext="text"><pre v-pre class="language-text"><code> TINYINT
 ...
 CHAR
 VARCHAR
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="conversion" tabindex="-1"><a class="header-anchor" href="#conversion" aria-hidden="true">#</a> Conversion</h2>
<p>In addition to basic conversions by type，<code v-pre>GeneralWritableExtractor</code> also supports some other conversion functions
according to options.
These options are managed in <code v-pre>com.bytedance.bitsail.conversion.hive.ConvertToHiveObjectOptions</code>, including:</p>
...
<p>When there is an error in the data conversion, this option can decide to report the error or ignore the error and
convert to null.</p>
<p>For example, when converting a string &quot;123k.i123&quot; to double-type hive data, an error will be reported because the string
cannot be recognized as a float number.</p>
<ul>
<li>If <code v-pre>convertErrorColumnAsNull=true</code>, ignore this error and convert this string to null.</li>
<li>If <code v-pre>convertErrorColumnAsNull=false</code>, a converting error exception is reported.</li>
</ul>
...
<p>If the incoming Row field type to be converted is <code v-pre>com.bytedance.bitsail.common.column.DateColumn</code> which is initialized
by <code v-pre>java.sql.Timestamp</code>, this date column will be converted to a timestamp value.</p>
<h3 id="nullstringasnull" tabindex="-1"><a class="header-anchor" href="#nullstringasnull" aria-hidden="true">#</a> nullStringAsNull</h3>
<p>If the incoming Rowfield data to be converted is null and the target hive data type is string, the user can choose to
convert it to null or an empty string &quot;&quot;.</p>
<table>
<thead>
<tr>
<th>Parameter</th>
...
<p>This option determines the precision when converting a date column to timestamp. The optional values are &quot;SECOND&quot; and &quot;
MILLISECOND&quot;.</p>
<p>For example, when converting &quot;2022-01-01 12:34:56&quot; to timestamp, different value will be returned according to
datePrecision:</p>
<ul>
...
<p>The following describes how to develop with <code v-pre>GeneralHiveExtractor</code>.</p>
<h3 id="initialization" tabindex="-1"><a class="header-anchor" href="#initialization" aria-hidden="true">#</a> Initialization</h3>
<p>After creating a <code v-pre>GeneralHiveExtractor</code> instance，the following steps are required:</p>
<h4 id="_1-set-column-mapping-and-field-names" tabindex="-1"><a class="header-anchor" href="#_1-set-column-mapping-and-field-names" aria-hidden="true">#</a> 1. Set <b>column mapping</b> and <b>field names</b></h4>
<p>fieldNames and columnMapping determine the <code v-pre>Row</code> order in which the Hive fields are written.</p>
<ul>
<li>columnMapping:  The mapping of field names stored in Map form to field positions in hive.</li>
<li>fieldNames: Row field names in order.</li>
</ul>
<p>The following example shows how these two parameters are set:</p>
<ul>
<li>The structure of hive table to be written <span id="hive_example">hive_example</span> is:</li>
</ul>
<table>
<thead>
<tr>
...
<ul>
<li><code v-pre>Row</code> to convert:</li>
</ul>
...
<li>According to <code v-pre>Row</code>, the <code v-pre>fieldNames</code> needs to be set as:</li>
</ul>
...
<li>If want to achive mapping of <code v-pre>row_field_0-&gt;field_a</code>,<code v-pre>row_field_1-&gt;field_b</code>, <code v-pre>row_field_2-&gt;field_c</code>, the <code v-pre>olumnMapping</code>
needs to be set as:</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_2-set-conversion-parameters" tabindex="-1"><a class="header-anchor" href="#_2-set-conversion-parameters" aria-hidden="true">#</a> 2. Set conversion parameters</h4>
<p>After building a <code v-pre>ConvertToHiveObjectOptions</code>，developers need to set it to <code v-pre>GeneralWritableExtractor</code>。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="_3-initialize-objectinspector" tabindex="-1"><a class="header-anchor" href="#_3-initialize-objectinspector" aria-hidden="true">#</a> 3. Initialize ObjectInspector</h4>
<p><code v-pre>GeneralWritableExtractor</code> offers a interface to initialize ObjectInspector for converting.</p>
...
<li><code v-pre>columnNames</code>: A string consisting of field names in hive, separated by <code v-pre>','</code>, in the same order in hive.</li>
<li><code v-pre>columnsType</code>: A string consisting of data types in hive, separated by <code v-pre>','</code>, in the same order in hive.</li>
</ul>
<p>Take the above test table (<a href="#hive_example">hive_example</a>) as an example:</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="example-code" tabindex="-1"><a class="header-anchor" href="#example-code" aria-hidden="true">#</a> Example code</h3>
