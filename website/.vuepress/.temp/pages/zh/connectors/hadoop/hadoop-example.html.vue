<template><div><h1 id="hadoop连接器使用示例" tabindex="-1"><a class="header-anchor" href="#hadoop连接器使用示例" aria-hidden="true">#</a> Hadoop连接器使用示例</h1>
<p>下面展示了如何使用用户参数配置读取如下json格式hdfs文件。</p>
<ul>
<li>示例json数据</li>
</ul>
