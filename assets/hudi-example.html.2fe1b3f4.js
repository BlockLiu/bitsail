import{_ as t,r as o,o as e,c as p,a as n,b as s,d as u,w as i,e as c}from"./app.f58ef234.js";const l={},r=n("h1",{id:"hudi-connector-examples",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#hudi-connector-examples","aria-hidden":"true"},"#"),s(" Hudi connector examples")],-1),d=c(`<h2 id="hudi-reader-example" tabindex="-1"><a class="header-anchor" href="#hudi-reader-example" aria-hidden="true">#</a> Hudi reader example</h2><p>Configuration for reading the test hudi table:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function k(q,v){const a=o("RouterLink");return e(),p("div",null,[r,n("p",null,[s("Parent document: "),u(a,{to:"/src/connectors/hudi/hudi.html"},{default:i(()=>[s("hudi-connector")]),_:1})]),d])}const b=t(l,[["render",k],["__file","hudi-example.html.vue"]]);export{b as default};
