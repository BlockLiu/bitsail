import{_ as n,o as s,c as a,e as t}from"./app.f58ef234.js";const o={},e=t(`<h1 id="hdfs-s-example" tabindex="-1"><a class="header-anchor" href="#hdfs-s-example" aria-hidden="true">#</a> HDFS&#39;s Example</h1><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
(
    ...
    STORED AS INPUTFORMAT &#39;org.apache.hadoop.hive.ql.io.parquet.MapredParquetInputFormat&#39;
        OUTPUTFORMAT &#39;org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat&#39; 
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,12),p=[e];function u(i,l){return s(),a("div",null,p)}const c=n(o,[["render",u],["__file","StreamingFile_Example.html.vue"]]);export{c as default};
