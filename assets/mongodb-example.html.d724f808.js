import{_ as t,r as o,o as e,c as p,a as n,b as s,d as c,w as l,e as i}from"./app.f58ef234.js";const u={},r=n("h1",{id:"mongodb-connector-examples",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#mongodb-connector-examples","aria-hidden":"true"},"#"),s(" MongoDB connector examples")],-1),d=i(`<hr><p>Suppose starting a local MongoDB with connection url <code>mongodb://localhost:1234</code>. We create a database <code>test_db</code> and a collection <code>test_collection</code> on it.</p><h2 id="mongodb-reader" tabindex="-1"><a class="header-anchor" href="#mongodb-reader" aria-hidden="true">#</a> MongoDB Reader</h2><p>If the documents contains (_id, string_field, int_field) these three fields, we can use the following configuration to read.</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
   ...
   <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,8);function k(v,m){const a=o("RouterLink");return e(),p("div",null,[r,n("p",null,[s("Parent document: "),c(a,{to:"/src/connectors/mongodb/mongodb.html"},{default:l(()=>[s("mongodb-connector")]),_:1})]),d])}const b=t(u,[["render",k],["__file","mongodb-example.html.vue"]]);export{b as default};
