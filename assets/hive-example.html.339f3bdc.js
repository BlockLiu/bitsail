import{_ as t}from"./_plugin-vue_export-helper.cdc0426e.js";import{o as e,c as o,a as n,b as s,d as p,w as i,e as l,r as u}from"./app.0284c6a0.js";const c={},r=n("h1",{id:"hive连接器使用示例",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#hive连接器使用示例","aria-hidden":"true"},"#"),s(" Hive连接器使用示例")],-1),d=l(`<p>下面展示如何使用用户参数配置读取测试hive表:</p><h2 id="测试hive表信息" tabindex="-1"><a class="header-anchor" href="#测试hive表信息" aria-hidden="true">#</a> 测试hive表信息</h2><ul><li>示例hive信息： <ul><li><p>hive库名: test_db</p></li><li><p>hive表名: test_table</p></li><li><p>metastore uri地址: <code>thrift://localhost:9083</code></p></li><li><p>分区: p_date</p></li><li><p>表结构:</p><table><thead><tr><th>字段名</th><th>字段类型</th><th>说明</th></tr></thead><tbody><tr><td>id</td><td>bigint</td><td></td></tr><tr><td>state</td><td>string</td><td></td></tr><tr><td>county</td><td>string</td><td></td></tr><tr><td>p_date</td><td>string</td><td>分区字段</td></tr></tbody></table></li></ul></li></ul><h2 id="hive读连接器示例" tabindex="-1"><a class="header-anchor" href="#hive读连接器示例" aria-hidden="true">#</a> hive读连接器示例</h2><p>读取上述测试hive表的用户配置:</p><div class="language-json line-numbers-mode" data-ext="json"><pre class="language-json"><code><span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
   ...
   <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,9);function v(k,q){const a=u("RouterLink");return e(),o("div",null,[r,n("p",null,[s("上级文档: "),p(a,{to:"/zh/documents/docs/connectors/hive/hive.html"},{default:i(()=>[s("hive连接器")]),_:1})]),d])}const h=t(c,[["render",v],["__file","hive-example.html.vue"]]);export{h as default};
